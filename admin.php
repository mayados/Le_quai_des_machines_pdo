...
<div id="container-page">
         ...
         <form action="traitement.php?action=ajouterMenu" method="post">
                ...
                <label>
                    ...
                    <!-- required pour indiquer que c'est un champ qui doit obligatoirement être rempli -->
                     <input class="form-champ" required type="text" name="jour">
                    </label>
            </p>
            <p>
                <label>
                    <p class="label-p">Entree :</p>
                    <input class="form-champ" required type="text" name="entree">
                </label>
            </p>
            <p>
                <label>
                    <p class="label-p">Plat :</p>
                    <input class="form-champ" required type="text" name="plat">
                </label>
            </p>
            <p>
                <label>
                    <p class="label-p">Dessert :</p>
                    <input class="form-champ" required type="text" name="dessert">
                </label>
            </p>
            <p>
    ...
    <a id="recap" href="index.php">Retour accueil restaurant</a>            
